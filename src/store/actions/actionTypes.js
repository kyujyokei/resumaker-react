...
export const JOB_STATE_RESET = 'JOB_STATE_RESET';
export const JOB_GID_START = 'JOB_GID_START';
...
export const SCHOOL_STATE_RESET = 'SCHOOL_STATE_RESET';
export const SCHOOL_GID_START = 'SCHOOL_GID_START';
export const SCHOOL_GID_SUCCESS = 'SCHOOL_GID_SUCCESS';
export const SCHOOL_GID_FAIL = 'SCHOOL_GID_FAIL';
export const SCHOOL_EN_PATCH = 'SCHOOL_EN_PATCH';
export const SCHOOL_PATCH_START = 'SCHOOL_PATCH_START';
export const SCHOOL_PATCH_SUCCESS = 'SCHOOL_PATCH_SUCCESS';
export const SCHOOL_PATCH_FAIL = 'SCHOOL_PATCH_FAIL';
